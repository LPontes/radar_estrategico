...
> **Purpose**: Declarative synthetic data generation for EDA e-commerce pipeline — ShadowTraffic v1.17.0
...
| File | Purpose |
|------|---------|
| [patterns/ecommerce-postgres.md](patterns/ecommerce-postgres.md) | **KEY**: Full EDA config — customers+products+orders→Postgres, reviews→JSONL |
...
|-------|---------------|----------|
| EDA-builder | patterns/ecommerce-postgres.md | Generate EDA Day 1 data pipeline |
