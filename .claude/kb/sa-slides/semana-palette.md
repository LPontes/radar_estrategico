...
> Alternative color palette for the Sprint Analitica slide decks. Used instead of the sa navy/cyan/gold palette. Based on the Sprint Analitica blue brand color.

## When to Use

Use this palette for all **Sprint Analitica** presentation decks (`presentation/d1-*.html` through `d4-*.html`). The standard sa navy palette is used for Formacao lesson decks (`presentation/l0-*/`, `presentation/l1-*/`).
...
:root {
  ...
  /* SEMANTIC COLORS (unchanged from sa) */
...
## Key Differences from sa Navy Palette

| Property | sa Navy | Semana Black |
|----------|-----------|-------------|
| `--bg` | `#030616` (dark navy) | `#08080a` (true black) |
| `--surface` | `#0c1122` (navy-gray) | `#111114` (charcoal) |
| `--accent` | `#0aabec` (electr cyan) | `#4a9eff` (Academy blue) |
| `--text-dim` | `#94a3b8` (slate) | `#6e7a8c` (neutral gray) |
...
- NEVER use sa cyan (`#00b4ff`) — use Academy blue (`#4a9eff`) instead
- NEVER mix palettes — a deck is either sa navy OR Semana black, never both
