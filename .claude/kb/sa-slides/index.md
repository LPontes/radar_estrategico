...
| File | Purpose |
|------|---------|
| [design-system.md](design-system.md) | sa color palette, CSS variables, 4-font stack, branding bar |
...
The `sa-slide-builder` agent reads this KB automatically when creating slides.
...
| `--brand` | `#ff9900` | Electric Orange (Action) |
| `--bg` | `#030616` | Dark Navy Background |
| `--text` | `#f3f4f6` | Clean White Text |
| `--text-dim` | `#94a3b8` | Muted Slate Text |
