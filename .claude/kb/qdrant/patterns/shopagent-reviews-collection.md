# EDA Reviews Collection

> **Purpose**: Qdrant collection configuration for EDA e-commerce reviews with payload schema and filtered search
> **MCP Validated**: 2026-04-12

## When to Use

- Setting up Qdrant for Day 2 RAG pipeline
- Configuring the `EDA_reviews` collection for semantic search on reviews
- Filtered search by rating or sentiment

## Implementation

```python
"""Configure Qdrant collection for EDA reviews."""
...
|---------|-------|-------------|
| `collection_name` | `"EDA_reviews"` | EDA reviews collection |
