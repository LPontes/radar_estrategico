...
> **Purpose**: LLM evaluation framework for EDA — test tool selection correctness and answer quality with DeepEval
...
| File | Purpose |
|------|---------|
| [patterns/agent-evaluation.md](patterns/agent-evaluation.md) | **KEY**: Batch evaluate EDA tool routing and answer quality |
...
|-------|---------------|----------|
| EDA-builder | patterns/agent-evaluation.md | Day 4 quality validation before live demo |
