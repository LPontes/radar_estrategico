...
> **Purpose**: LangChain + LangGraph agent framework for EDA — autonomous routing between Supabase SQL and Qdrant semantic search
...
|-------|---------------|----------|
| EDA-builder | patterns/react-agent-dual-tools.md | Day 3 autonomous agent with dual-store routing |
