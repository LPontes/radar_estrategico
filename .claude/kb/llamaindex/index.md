...
> **Purpose**: RAG ingestion and query framework for EDA — JSONL reviews → embeddings → Qdrant via LlamaIndex
...
|-------|---------------|----------|
| EDA-builder | patterns/jsonl-to-qdrant.md | Day 2 RAG pipeline: reviews JSONL → Qdrant |
