...
> **Purpose**: Complete ingest → embed → store → query flow as reusable functions for EDA
...
```python
"""EDA RAG pipeline — modular ingest and query functions."""
...
| `COLLECTION` | `"EDA_reviews"` | Qdrant collection name |
