...
> **Purpose**: Ingest EDA reviews JSONL → FastEmbed embeddings → Qdrant collection via LlamaIndex
...
```python
"""EDA Day 2: Ingest reviews JSONL into Qdrant via LlamaIndex."""
...
def ingest_reviews(
    ...
    collection_name: str = "EDA_reviews",
) -> VectorStoreIndex:
...
|---------|-------|-------------|
| `collection_name` | `"EDA_reviews"` | Qdrant collection for reviews |
...
- [Qdrant Reviews Collection](../../qdrant/patterns/EDA-reviews-collection.md)
